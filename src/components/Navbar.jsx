      ...
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        > 
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer flex '>
            Ayesha &nbsp;
            <span className='sm:block hidden'> | Full-Stack Developr</span>
          </p>
        </Link>
            
            <div className="flex gap-4 ml-5">
            <a href="https://www.linkedin.com/in/ayesha-techx-078751348/" target="_blank">
            ...
            <a href="https://x.com/AyeshaTechX"  target="_blank">
